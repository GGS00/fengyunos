...
<head>
    ...
    <link rel="stylesheet" href="css/wei.css?0002">    
    <style>
...
<div class="mui-content musicPlay" style="padding-top:0;display:none;">
  <header id="header" class="mui-bar mui-bar-nav" style="background:#FAFAFA">
      ...
      <h1 class="mui-title myRebate saveMusic" onclick="saveMusic()" style="left:80%;width:17%">完成</h1>
  ...
  function addPic(){
   ...
   var syncUpload = function() {
    ...
    function imgshow(data){
             ...
             $(".editPlace").append("<div class=\"editVersion\"><i class=\"fa fa-minus-square-o deletePic\" onclick=\"deletePic(this)\"></i><img class=\"thumbnail\" src=\"" + data + "\"><textarea  class=\"editText\" maxlength=\"100\" placeholder=\"点击添加文字(100字以内)\"></textarea><i class=\"fa fa-angle-up moveup\"></i><i class=\"fa fa-angle-down movedown\"></i></div>");
   ...
   function _addLoading(){
    $("body").append("<div id=\"loadingToast\" class=\"weui_loading_toast\">\n\
                    ...
                    <div class=\"weui_toast\">\n\
                        ...
                        <p class=\"weui_toast_content\">歌曲加载中</p>\n\
                    </div>\n\
                </div>")  
  }

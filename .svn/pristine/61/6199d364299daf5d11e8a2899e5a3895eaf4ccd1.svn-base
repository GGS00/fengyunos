...
{
    if (GLOB_SHOPID) {
        window.location = "wshop.php?aid=" + GLOB_AID + "&alias=" + GLOB_alias + "&selltype=" + GLOB_SELLTYPE + "&shopid=" + GLOB_SHOPID + "&isshare=" + GLOB_ISSHARE;
    }
    else {
        window.location = "wshop.php?aid=" + GLOB_AID + "&alias=" + GLOB_alias + "&selltype=" + GLOB_SELLTYPE + "&isshare=" + GLOB_ISSHARE;
    }

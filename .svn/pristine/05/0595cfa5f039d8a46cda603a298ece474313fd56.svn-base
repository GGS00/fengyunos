...
//                    }
               ...
               else
               {
                    ...
                    if(null ===  shopID ||"" === shopID|| undefined === shopID){
                          ...
                          sessionStorage["sessionshoptype"] = shoptype;
                          window.location.href="index.html#/shop?aid="+agentid+"&alias="+aliasid+"&shopid="+shopID+"&selltype="+selltype+"&shoptype="+shoptype+"&isshare=1";
                    }
               }
            },
            error : function() {  

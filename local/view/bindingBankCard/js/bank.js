    ...
    $.ajax({
        ...
        success: function (data) {
            for (var i = 0; i < data.resultValue.length; i++) {
                ...
                <img src=\""+data.resultValue[i].bank_logo_url+"\"><span class=\"bankName\">" + data.resultValue[i].bank_name + "("+ data.resultValue[i].branch_name +")</span><span class=\"bankCode\">" + data.resultValue[i].bank_account + "</span></div>");
            }
        },
        //请求失败遇到异常触发

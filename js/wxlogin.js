...
//                    }
               ...
               else
               {
                    ...
                    if(null ===  shopID ||"" === shopID|| undefined === shopID){
                          ...
                          window.location.href="index.php?"+"&shoptype="+shoptype+"&"+randomstr;
                    }else{
                          sessionStorage["sessionselltype"] = d.sell_type;
                          sessionStorage["sessionshoptype"] = shoptype;
                          window.location.href="wshop.php?aid="+agentid+"&alias="+aliasid+"&shopid="+shopID+"&selltype="+selltype+"&shoptype="+shoptype+"&isshare=1?"+randomstr;
                    }
               }
            },
            error : function() {  
